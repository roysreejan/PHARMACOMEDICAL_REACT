...
const Registration = ()=>{
    ...
    const registrationSubmit= ()=>{
        var obj = {name: name, email: email, phoneNumber: phoneNumber, password: password, password_confirmation: password, dob: dob, gender: gender, role: role};
    ...
    return(
        ...
        <Form onSubmit={handleSubmit}>
                ...
                <div class="form-group" onChange={(e) => setPhoneNumber(e.target.value)}>
                ...
                <div class="form-group" onChange={(e) => setPassword_confirmation(e.target.value)}>
            ...
            <div class="form-group p-1" onClick={registrationSubmit} disabled={!validateForm()}>
                <span>
                    <input type="submit" name="submit" value="Sign up" class="btn btn-info" style={{background: "#31D2F2", padding: "10px", width: "100% "}} />
                </span>
            </div>
